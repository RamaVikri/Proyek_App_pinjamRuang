        ...
        <div class="container">
            <div class="row">
                <div class="col-8 mx-auto text-center">
                    <h2 class="mb-3 text-capitalize">Rooms</h2>
                    <ul class="list-inline breadcrumbs text-capitalize" style="font-weight:500">
                        <li class="list-inline-item"><a href="{{ route('home') }}">Home</a>
                        </li>
                        <li class="list-inline-item">/ &nbsp; <a href="{{ route('room') }}">Room</a>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="row position-relative">
                <div class="col-xl-3 col-lg-4 col-md-6 mt-4">
                    <div class="card bg-transparent border-0 text-center">
                        <div class="card-img">
                            <img loading="lazy" decoding="async" src="https://picsum.photos/id/30/200/300"
                                alt="Scarlet Pena" class="rounded w-100" width="300" height="332">
                            <a href="{{ route('user.bookingform') }}" class="card-social">
                                <div class="">
                                    Book Now &raquo; <i class="fas fa-clock"></i>
                                </div>
                            </a>
                        </div>
                        <div class="card-body">
                            <h3>Co-working Space A</h3>
                            <p>kapasitan 5-10 orang</p>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-4 col-md-6 mt-4">
                    <div class="card bg-transparent border-0 text-center">
                        <div class="card-img">
                            <img loading="lazy" decoding="async" src="https://picsum.photos/id/20/200/300"
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 mt-4">
                    <div class="card bg-transparent border-0 text-center">
                        <div class="card-img">
                            <img loading="lazy" decoding="async" src="https://picsum.photos/id/15/200/300" alt="Leslie Pena"
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 mt-4">
                    <div class="card bg-transparent border-0 text-center">
                        <div class="card-img">
                            <img loading="lazy" decoding="async" src="https://picsum.photos/id/13/200/300"
                                alt="Scarlet Pena" class="rounded w-100" width="300" height="332">
                             <a href="{{ route('user.bookingform') }}" class="card-social">
                                <div class="">
                                    Book Now &raquo; <i class="fas fa-clock"></i>
